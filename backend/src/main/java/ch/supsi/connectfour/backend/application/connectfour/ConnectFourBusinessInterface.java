 ...
 * related. We chose to link the game-related methods with the persistence-related ones (through inheritance) because persistence
 * in its current state (it is not generic enough) cannot exist without a game.
 */
